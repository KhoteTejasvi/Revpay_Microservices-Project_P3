...
@Component({
      ...
      <div class="card">
        <form [formGroup]="form" (ngSubmit)="onSubmit()">
          <div class="field">
            ...
            <input formControlName="receiverEmail" type="email" placeholder="friend@example.com"/>
          ...
          <div class="field">
            ...
            <input formControlName="description" type="text" placeholder="What's this for?"/>
          </div>

          <div class="field">
            <label>Note <span class="optional">(optional)</span></label>
            <input formControlName="note" type="text" placeholder="Personal note..."/>
          </div>
  ...
  styles: [`
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .back-btn { color: #65758b; text-decoration: none; font-size: 0.85rem; display: inline-block; margin-bottom: 0.75rem; }
    ...
    .currency-tag { padding: 0 1rem; color: #64748b; font-size: 0.85rem; border-right: 1px solid rgba(255,255,255,0.08); }
    .amount-wrap input { border: none; background: transparent; padding: 0.875rem 0.75rem; color: #fff; font-size: 0.95rem; outline: none; width: 100%; }
    .submit-btn { width: 100%; padding: 0.9rem; background: linear-gradient(135deg,#7c3aed,#4f46e5); color: white; border: none; border-radius: 12px; font-size: 1rem; font-weight: 600; cursor: pointer; margin-top: 0.5rem; }
